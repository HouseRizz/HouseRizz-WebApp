  ...
  return (function a(b, c, d) {
  ...
  })(
    {
      1: [
        function (a, b, c) {
          "use strict";
          var d = a("babel-runtime/helpers/create-class")["default"],
            e = a("babel-runtime/helpers/class-call-check")["default"],
            f = a("babel-runtime/core-js/set")["default"],
          ...
          var h = a("./Utils"),
            ...
            l = a("./Log"),
            m = g(l),
            n = a("./NotificationUtil"),
            o = g(n),
            p = (function () {
              function a(b) {
                e(this, a),
                  (this._apnsEnvironment = b),
                  (this._apnsToken = null),
                  (this._notificationListeners = new f()),
                  (this._isPolling = !1),
                  (this._urlPath = null);
              }
              return (
                d(a, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return (
                        !this._isPolling &&
                        this.hasApnsToken &&
                        this._notificationListeners.size > 0
                      );
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      ...
                      b &&
                        this._notificationListeners.forEach(function (a) {
                          i["default"].isFunction(a)
                            ? a(b)
                            : i["default"].isFunction(a.handleNotification) &&
                              a.handleNotification(b);
                        });
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      if (
                        ...
                        throw new Error(
                          'notification listener must be either a funciton or an object with a function called "handleNotification"'
                        );
                      return (
                        this._notificationListeners.add(a),
                        this._parkConnection(),
                        a
                      );
                    },
                  },
                  ...
                  },
                  {
                    ...
                    get: function () {
                      return (
                        !i["default"].isNullOrUndefined(this._urlPath) &&
                        !i["default"].isNullOrUndefined(this._apnsToken)
                      );
                    },
                  },
                ]),
        ...
        function (a, b, c) {
          ...
          var g = a("./Constants"),
            ...
            o = (function () {
              function a() {
                e(this, a),
                  (this._prodApnsConnector = new n["default"](
                    h["default"].PRODUCTION_ENVIRONMENT
                  )),
                  (this._devApnsConnector = new n["default"](
                    h["default"].DEVELOPMENT_ENVIRONMENT
                  ));
              }
              return (
                d(a, [
                  {
                    ...
                    value: function (a) {
                      ...
                      return this._registerContainerWithConnector(a, b).then(
                        function () {
                          return a;
                        }
                      );
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      return this._getConnectorForContainer(
                        a
                      ).removeNotificationListener(a);
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      ...
                      throw l["default"].makeConfigurationError(
                        "No apnsEnvironment configured for container: " +
                  ...
                  },
                  {
                    ...
                    value: function (a, b) {
                      ...
                      return b.hasApnsToken
                        ? ((c = "register"),
                          (d = {
                            apnsEnvironment: a.apnsEnvironment,
                            apnsToken: b.apnsToken,
                          }),
                          e.setApiActionName(c).setPayload(d),
                          a.sendRequest(e)["catch"](function (c) {
                            if (
                              c.ckErrorCode ===
                              l["default"].UNEXPECTED_SERVER_RESPONSE
                            )
                              return b.addNotificationListener(a), a;
                            throw c;
                          }))
                        : ((c = "create"),
                          (d = { apnsEnvironment: a.apnsEnvironment }),
                          e.setApiActionName(c).setPayload(d),
                          a
                            .sendRequest(e)
                            .then(function (a) {
      ...
      3: [
        function (a, b, c) {
          (function (d) {
            ...
            function g(a) {
              return (
                !D["default"].isNullOrUndefined(a) &&
                !D["default"].isNullOrUndefined(a.recordName) &&
                !D["default"].isNullOrUndefined(a.fieldName)
              );
            }
            function h(a) {
            ...
            function i(a) {
              var b = [],
                c = [];
              return (
                a._operations.forEach(function (a) {
                  var d = a.record,
                    i = d.fields;
                  D["default"].isNullOrUndefined(i) ||
                    s(d.fields).forEach(function (a) {
                      var i = d.fields[a];
                      e(i.value)
                        ? b.push(new I(d, a, i))
                        : f(i.value)
                        ? i.value.forEach(function (c, f) {
                            e(c) && b.push(new I(d, a, i, f));
                          })
                        : g(i.value)
                        ? c.push(new J(d, a, i))
                        : h(i.value) &&
                          i.value.forEach(function (b, e) {
                            g(b) && c.push(new J(d, a, i, e));
                          });
                    });
                }),
                { uploadInfos: b, rerefInfos: c }
              );
            }
            function j(a, b) {
              var c =
                ...
                e = new B["default"]()
                  ...
                  .setResponseClass(
                    x["default"].createGenericResponseClass("tokens")
                  )
                  .setPayload(d);
              return b.sendRequest(e);
            }
            function k(a, b) {
              var c = a.getAssetValueForUpload(),
                d = a.getUrlForUpload();
              return v["default"]
                .fetch(d, {
                  method: "POST",
                  ...
                  exposeImplementation: function (c) {
                    b._notifyAssetUploadStart(
                      c,
                      a.toAssetUploadStartEventPayload()
                    );
                  },
                })
                ["catch"](function () {
            ...
            function l(a, b) {
              return j(b, a._database, a.options)
                .then(function (c) {
                  return z["default"].Promise.all(
                    c.tokens.map(function (c, d) {
                      var e = b[d];
            ...
            function m(a, b) {
              var c = a._database,
                ...
                e = new B["default"]()
                  ...
                  .setResponseClass(
                    x["default"].createGenericResponseClass("assets")
                  )
                  .setPayload(d);
              return c.sendRequest(e).then(function (a) {
                if (a.hasErrors)
                  throw (
                    (H["default"].warn("rereference failed", a.errors),
                    F["default"].fromServerError(a.errors[0]))
                  );
            ...
            function n(a) {
              var b = z["default"].Promise.resolve(),
                c = i(a),
                d = c.uploadInfos,
                e = c.rerefInfos;
              return (
                d.length > 0 &&
                  (H["default"].info("uploading assets", d), (b = l(a, d))),
                e.length > 0 &&
                  (H["default"].info("rereferencing assets", e),
                  (b = b.then(function () {
                    return m(a, e);
                  }))),
                b
            ...
            var o = a("babel-runtime/helpers/create-class")["default"],
              p = a("babel-runtime/helpers/class-call-check")["default"],
              q = a("babel-runtime/helpers/get")["default"],
              r = a("babel-runtime/helpers/inherits")["default"],
              s = a("babel-runtime/core-js/object/keys")["default"],
              t = a("babel-runtime/helpers/interop-require-default")["default"];
            Object.defineProperty(c, "__esModule", { value: !0 });
            var u = a("./Fetch"),
              v = t(u),
              w = a("./Response"),
                  ...
                  o(a, [
                    {
                      key: "toRequestToken",
                      value: function () {
                        var a = { fieldName: this._fieldName };
                        return (
                          D["default"].isNullOrUndefined(
                            this._record.recordType
                          ) || (a.recordType = this._record.recordType),
                          D["default"].isNullOrUndefined(
                            this._record.recordName
                          ) || (a.recordName = this._record.recordName),
                          a
                        );
                      },
                    },
                    ...
                    },
                    {
                      ...
                      value: function (a) {
                        D["default"].isNullOrUndefined(this._indexInField)
                          ? (this._field.value = a)
                          : (this._field.value[this._indexInField] = a);
                      },
                    },
                    {
                      key: "getUrlForUpload",
                    ...
                    },
                    {
                      ...
                      value: function () {
                        var a = D["default"].isNullOrUndefined(
                          this._indexInField
                        )
                          ? this._field.value
                  ...
                  o(b, [
                    {
                      ...
                      value: function () {
                        ...
                        return D["default"].isNullOrUndefined(
                          this._indexInField
                        )
                          ? a
                          : a[this._indexInField];
                      },
                    },
                  ]),
                  b
            ...
            (c["default"] = { handleAssetsInBatchBeforeCommit: n }),
              (b.exports = c["default"]);
          }).call(
            this,
            "undefined" != typeof global
      ...
      4: [
        function (a, b, c) {
          ...
          var d = a("babel-runtime/helpers/create-class")["default"],
            e = a("babel-runtime/helpers/class-call-check")["default"],
            f = a("babel-runtime/core-js/promise")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var g = (function () {
              function a() {
                ...
                d(a, [
                  {
                    ...
                    value: function () {
                      var a = {},
                        b = new this.Promise(function (b, c) {
      ...
      5: [
        function (a, b, c) {
          "use strict";
          var d = a("babel-runtime/helpers/get")["default"],
            e = a("babel-runtime/helpers/inherits")["default"],
            f = a("babel-runtime/helpers/create-class")["default"],
            g = a("babel-runtime/helpers/class-call-check")["default"],
            h = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var i = a("./Utils"),
            j = h(i),
            k = "ACCESS_DENIED",
            ...
            u = "THROTTLED",
            v = "TRY_AGAIN_LATER",
            w = "UNIQUE_FIELD_ERROR",
            x = "VALIDATING_REFERENCE_ERROR",
            y = "ZONE_NOT_FOUND",
            z = [k, l, m, n, o, p, q, r, s, t, u, v, w, x, y],
            A = "UNKNOWN_ERROR",
            B = "NETWORK_ERROR",
            C = "SERVICE_UNAVAILABLE",
            D = "INVALID_ARGUMENTS",
            E = "UNEXPECTED_SERVER_RESPONSE",
            F = "CONFIGURATION_ERROR",
            G = "AUTH_PERSIST_ERROR",
            H = "SIGN_IN_FAILED",
            I = [A, B, C, D, E, F, G, H],
            J = {
            ...
            K = (function (a) {
              function b(a) {
                ...
                g(this, b),
                  ...
                  j["default"].isNullOrUndefined(o) &&
                    (o = b.isKnownServerErrorCode(e) ? e : A),
                  (this._ckErrorCode = o),
                  (this._uuid = c),
                  (this._reason = j["default"].isNullOrUndefined(h) ? o : h),
                  (this._serverErrorCode = e),
                  (this._extensionErrorCode = f),
                  (this._retryAfter = i),
                  (this._recordName = l),
                  (this._subscriptionID = k),
                  (this._zoneID = m),
                  (this._redirectURL = n),
                  ...
                  [
                    {
                      key: "isErrorObject",
                      value: function (a) {
                        var b = a.serverErrorCode,
                          c = a.extensionErrorCode;
                        return (
                          !j["default"].isNullOrUndefined(b) ||
                          !j["default"].isNullOrUndefined(c)
                        );
                      },
                    },
                    {
                    ...
                    },
                    {
                      ...
                      value: function (a) {
                        return (
                          j["default"].isNullOrUndefined(a.redirectUrl) ||
                            (a.redirectURL = a.redirectUrl),
                          j["default"].isNullOrUndefined(a.subscriptionId) ||
                            (a.subscriptionID = a.subscriptionId),
                          new b(a)
                        );
                      },
                    },
                    {
                      ...
                      value: function (a, c) {
                        var d = J[a];
                        return (
                          j["default"].isNullOrUndefined(d) && (d = a),
                          j["default"].isNullOrUndefined(c) || (d += ": " + c),
                          new b({ ckErrorCode: a, reason: d })
                        );
                      },
                    },
                    {
      ...
      6: [
        function (a, b, c) {
          ...
          var i = a("./CKError"),
            ...
            w = "ckAPIToken",
            x = "ckWebAuthToken",
            y = "X-Apple-CloudKit-Request-ISO8601Date",
            z = "X-Apple-CloudKit-Request-KeyID",
            A = "X-Apple-CloudKit-Request-SignatureV1",
            B = {
              parameters: {
              ...
              function b() {
                g(this, b),
                  d(
                    ...
                    "constructor",
                    this
                  ).call(this, r["default"].extend({}, B)),
                  (this._wsApiVersion = p["default"].WS_API_VERSION),
                  (this._host = p["default"].URL_PREFIX),
                  (this._containerIdentifier = null),
                  (this._containerEnvironment = null),
                  (this._databaseName = null),
                  (this._containerEnvironment = null),
                  (this._apiModuleName = null),
                  (this._responseClass = l["default"]);
              }
              return (
                e(b, a),
                f(b, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      var a = this;
                      return d(Object.getPrototypeOf(b.prototype), "send", this)
                        .call(this)
                        ["catch"](function (a) {
                          throw (
                            (t["default"].warn(a, a.stack),
                            j["default"].makeNetworkError(a))
                          );
                        })
                        .then(function (b) {
                          var c = b.status,
                          ...
                          return b
                            ...
                            .then(function (a) {
                              try {
                                ...
                                return 503 === c
                                  ? v["default"].Promise.reject(
                                      j["default"].makeServiceUnavailableError()
                                    )
                                  : v["default"].Promise.reject(
                                      j["default"].makeUnexpectedServerResponse(
                                        "Could not parse json: " + a
                                      )
                                    );
                              }
                            })
            ...
            m = (function (a) {
              function b(a, c) {
                g(this, b),
                  ...
                  (this._moreComing = c.body[k]),
                  (this._syncToken = c.body[l]);
              }
              return (
                e(b, a),
                f(b, [
      ...
      8: [
        function (a, b, c) {
          "use strict";
          var d = a("babel-runtime/core-js/object/define-properties")[
              "default"
            ],
            e = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var f = a("./CloudKitImpl"),
            g = e(f),
            h = a("./CKError"),
            i = e(h),
            j = a("./Constants"),
            ...
            y = d(
              {
                configure: function (a) {
                  return (
                    m["default"].info("CloudKit.configure", a),
                    (x = new g["default"](a))
                  );
                },
                ...
                logToConsole: !!w["default"].getQueryParam(
                  "CloudKit.logToConsole"
                ),
              },
              {
                Promise: {
          ...
          if (
            "undefined" != typeof window &&
            ((window.CloudKit = y), "undefined" != typeof document)
          ) {
            var z = "document",
              A = window[z],
              B = A.createEvent("Event");
            B.initEvent(k["default"].CLOUDKIT_LOADED, !0, !0),
              A.dispatchEvent(B);
          }
          m["default"].info("build: " + k["default"].BUILD_VERSION),
            console.warn(
              "CloudKit JS version 1.x.x will be deprecated in the near future.\nPlease upgrade to version 2.x.x available at: https://cdn.apple-cloudkit.com/ck/2/cloudkit.js\nFor more information visit: https://developer.apple.com/documentation/cloudkitjs"
            ),
            (c["default"] = y),
            (b.exports = c["default"]);
        },
      ...
      9: [
        function (a, b, c) {
          ...
          var d = a("babel-runtime/helpers/create-class")["default"],
            e = a("babel-runtime/helpers/class-call-check")["default"],
            f = a("babel-runtime/core-js/promise")["default"],
            g = a("babel-runtime/core-js/object/keys")["default"],
            h = a("babel-runtime/core-js/object/values")["default"],
            i = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var j = a("./Utils"),
            k = i(j),
            l = a("./APNSManager"),
            ...
            t = a("./Fetch"),
            u = i(t),
            v = a("./auth/tokenAndSession/AuthTokenStore"),
            w = i(v),
            x = a("./Async"),
            y = i(x),
            z = (function () {
              function a(b) {
                ...
                if (
                  (e(this, a),
                  (this._apnsManager = new m["default"]()),
                  k["default"].isNullOrUndefined(b))
                )
                  throw q["default"].makeConfigurationError(
                    "A configuration object is required"
                  );
                var d = b.services || {};
                if (
                  (s["default"].setDelegate(d.logger),
                  (y["default"].Promise = d.Promise || f),
                  k["default"].isNode() &&
                    k["default"].isNullOrUndefined(d.fetch))
                )
                  throw q["default"].makeConfigurationError(
                    "Please provide an implementation of whatwg fetch via services.fetch"
                  );
                u["default"].setDelegate(d.fetch),
                  w["default"].setDelegate(d.authTokenStore);
                var g = b.containers;
                if (!k["default"].isArray(g))
                  throw q["default"].makeConfigurationError(
                    "conf.containers must be an array"
                  );
                var h = {};
      ...
      10: [
        function (a, b, c) {
          ...
          Object.defineProperty(c, "__esModule", { value: !0 });
          var e = a("./vBuildver.js"),
            f = d(e),
            g = a("./vSemver.js"),
            h = d(g),
            i = "production",
            j = "development",
            k = "https://api.apple-cloudkit.com",
            l = 1,
            m = "cloudkitloaded";
          (c["default"] = {
            CLOUDKIT_LOADED: m,
      ...
      11: [
        function (a, b, c) {
          ...
          var h = a("./Database"),
            ...
            m = g(l),
            n = a("./Response"),
            o = (g(n), a("./UserInfosResponse")),
            p = g(o),
            q = a("./UserInfo"),
            r = g(q),
            s = a("./auth/AuthFactory"),
            t = g(s),
            u = a("./Constants"),
            v = g(u),
            w = a("./Log"),
            ...
            A = (function () {
              function a(b, c) {
                e(this, a),
                  (this._apnsManager = c),
                  (this._containerIdentifier = b.containerIdentifier),
                  (this.environment = b.environment),
                  (this.apnsEnvironment =
                    b.apnsEnvironment || v["default"].DEVELOPMENT_ENVIRONMENT),
                  (this._auth = t["default"].fromContainerDefinition(this, b)),
                  (this._publicDatabase = new i["default"](
                    this,
                    !0,
                    b.publicDatabasePartition
                  )),
                  (this._privateDatabase = new i["default"](
                    this,
                    !1,
                    b.privateDatabasePartition
                  )),
                  (this._notificationListeners = new f());
              }
              return (
                d(a, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      var a = new m["default"]()
                        ...
                        .setApiActionName("lookup/contacts")
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      x["default"].info(
                        "Container#discoverUserInfoWithEmailAddress",
                        a
                      );
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      x["default"].info(
                        "Container#discoverUserInfoWithUserRecordName",
                        a
                      );
                      var b = k["default"].asArray(a).map(function (a) {
                          return { userRecordName: a };
                        }),
                        c = new m["default"]()
                          .setApiEntityName("users")
                          .setApiActionName("lookup/id")
                          .setPayload({ users: b })
                          .setResponseClass(p["default"]);
                      return this.publicCloudDatabase.sendRequest(c);
                    },
                  },
                  {
                    ...
                    value: function () {
                      ...
                      var a = new m["default"]()
                        .setApiEntityName("users")
                        .setApiActionName("current");
                      return this.publicCloudDatabase
                        .sendRequest(a)
                        .then(function (a) {
                          var b = a.httpResponse.body,
                            c = new r["default"](b);
                          return c;
                        });
                    },
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      x["default"].info("Notification", a, "handled by", this),
                        this._notificationListeners.forEach(function (b) {
                          try {
                            b(a);
                          } catch (c) {
                            x["default"].warn(
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return this._apnsManager.registerContainerForNotification(
                        this
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      return this._apnsManager.unregisterContainerForNotification(
                        this
                      );
                    },
                  },
                  {
                    key: "sendRequest",
                    value: function (a) {
                      a.setContainerIdentifier(this.containerIdentifier),
                        a.setContainerEnvironment(this.environment);
                      var b = this._auth.requestHandler(),
                        c = this._auth.responseHandler();
                      return z["default"].Promise.resolve(a)
                        .then(b)
                        .then(function (a) {
                          return a.send();
                        })
                  ...
                  },
                  {
                    ...
                    set: function (a) {
                      a !== v["default"].DEVELOPMENT_ENVIRONMENT &&
                        a !== v["default"].PRODUCTION_ENVIRONMENT &&
                        (x["default"].warn(
                          "Cannot use " +
                            a +
                            " as apnsEnvironment. Using " +
                            v["default"].DEVELOPMENT_ENVIRONMENT +
                            " instead."
                        ),
                        (a = v["default"].DEVELOPMENT_ENVIRONMENT)),
                        (this._apnsEnvironment = a);
                    },
                  },
                  {
                    key: "environment",
                  ...
                  },
                  {
                    ...
                    get: function () {
                      return this._apnsManager.isContainerRegisteredForNotifications(
                        this
                      );
                    },
                  },
        ...
        function (a, b, c) {
          ...
          function d(a, b) {
            var c =
              "Database#" +
              a +
              " is deprecated. Please use Database#" +
              b +
              " instead.";
            ...
            try {
              if (n["default"].isNullOrUndefined(b.zoneID)) {
                ...
                var c = a.some(function (a) {
                  return (
                    !n["default"].isNullOrUndefined(a.zoneID) ||
                    !n["default"].isNullOrUndefined(a.zoneName)
                  );
                });
                if (c) {
                  var d =
                    'record["zoneID"/"zoneName"] will be ignored. Use options.zoneID instead.';
                  j["default"].warn(d),
                    l["default"].reportDeprecatedOptionUsed(d);
                }
              }
            } catch (e) {
              j["default"].error(e);
          ...
          var f = a("babel-runtime/helpers/create-class")["default"],
            g = a("babel-runtime/helpers/class-call-check")["default"],
            h = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var i = a("./Log"),
            ...
            q = a("./QueryResponse"),
            r = h(q),
            s = a("./RecordsBatchBuilder"),
            t = h(s),
            u = a("./AssetUploadHelper"),
            v = h(u),
            w = a("./RecordsResponse"),
            x = h(w),
            y = a("./ChangedRecordsResponse"),
            z = h(y),
            A = a("./RecordZonesBatchBuilder"),
            B = h(A),
            C = a("./RecordZonesResponse"),
            D = h(C),
            E = a("./SubscriptionsBatchBuilder"),
            F = h(E),
            G = a("./SubscriptionsResponse"),
            H = h(G),
            I = a("./CKRequest"),
            J = h(I),
            K = a("./RecordsRequestOptions"),
            L = h(K),
            M = L["default"].forKeys(
              "zoneID",
              "numbersAsStrings",
                ...
                f(a, [
                  {
                    ...
                    value: function (a) {
                      ...
                      if (
                        (j["default"].info(
                          "CloudKit Database#performQuery",
                          a,
                          b
                        ),
                        a.isQueryResponse)
                        ...
                        return this.performQuery(
                          c.query,
                          n["default"].merge(M(c), b)
                        );
                      }
                      var d = n["default"].merge({ query: a }, M(b)),
                        e = new J["default"]()
                          .setApiEntityName("records")
                          .setApiActionName("query")
                          .setResponseClass(r["default"])
                          .setPayload(d);
                    ...
                    value: function (a) {
                      var b =
                        arguments.length <= 1 || void 0 === arguments[1]
                          ? {}
                          : arguments[1];
                      j["default"].info("CloudKit Database#fetchRecords", a, b),
                        e(a, b);
                      var c = p["default"]
                          .normalizeRecords(a)
                          .map(n["default"].makeKeysFilter("recordName")),
                        d = n["default"].merge({ records: c }, O(b)),
                        f = new J["default"]()
                          .setApiEntityName("records")
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      ...
                      return (
                        j["default"].info(
                          "CloudKit Database#saveRecords",
                          a,
                          b
                        ),
                        e(a, b),
                        this.newRecordsBatch(b).createOrUpdate(a).commit()
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      ...
                      return (
                        j["default"].info(
                          "CloudKit Database#deleteRecords",
                          a,
                          b
                        ),
                        e(a, b),
                        this.newRecordsBatch(b).forceDelete(a).commit()
                      );
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      var b = this,
                        c = v["default"].handleAssetsInBatchBeforeCommit(a);
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        j["default"].info("Database#saveRecordZones", a),
                        this.newRecordZonesBatch().create(a).commit()
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        j["default"].info("Database#deleteRecordZones", a),
                        this.newRecordZonesBatch()["delete"](a).commit()
                      );
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      ...
                      if (
                        (j["default"].info(
                          "Database#fetchChangedRecords",
                          a,
                          b
                        ),
                        a.isChangedRecordsResponse)
                      ) {
                        var c = a;
                        return this.fetchChangedRecords(
                          c.zoneID,
                          n["default"].merge(N(c), b)
                        );
                      }
                      var d = N(b);
                      ...
                      var e = new J["default"]()
                        .setApiEntityName("records")
                        .setApiActionName("changes")
                        .setPayload(d)
                        .setResponseClass(z["default"]);
                      return this.sendRequest(e);
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      j["default"].info("Database#fetchSubscriptions", a),
                        (a = n["default"].asArray(a).map(function (a) {
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        j["default"].info("Database#deleteSubscriptions", a),
                        this.newSubscriptionsBatch()["delete"](a).commit()
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        j["default"].info("Database#saveSubscriptions", a),
                        this.newSubscriptionsBatch().create(a).commit()
                      );
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        n["default"].isNullOrUndefined(this._partition) ||
                          a.setHost(this._partition),
                        a.setDatabaseName(this.isPublic ? "public" : "private"),
                        a.setApiModuleName("database"),
                        this._container.sendRequest(a)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      var b =
                        arguments.length <= 1 || void 0 === arguments[1]
                          ...
                          : arguments[1];
                      return (
                        d("fetchRecord", "fetchRecords"),
                        this.fetchRecords(a, b)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      var b =
                        arguments.length <= 1 || void 0 === arguments[1]
                          ...
                          : arguments[1];
                      return (
                        d("saveRecord", "saveRecords"), this.saveRecords(a, b)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      var b =
                        arguments.length <= 1 || void 0 === arguments[1]
                          ...
                          : arguments[1];
                      return (
                        d("deleteRecord", "deleteRecords"),
                        this.deleteRecords(a, b)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        d("fetchRecordZone", "fetchRecordZones"),
                        this.fetchRecordZones(a)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        d("saveRecordZone", "saveRecordZones"),
                        this.saveRecordZones(a)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        d("deleteRecordZone", "deleteRecordZones"),
                        this.deleteRecordZones(a)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        d("fetchSubscription", "fetchSubscriptions"),
                        this.fetchSubscriptions(a)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        d("deleteSubscription", "deleteSubscriptions"),
                        this.deleteSubscriptions(a)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        d("saveSubscription", "saveSubscriptions"),
                        this.saveSubscriptions(a)
                      );
                    },
                  },
                  {
        ...
        function (a, b, c) {
          ...
          var g = a("./Utils"),
            ...
            o = (function () {
              function a() {
                e(this, a),
                  h["default"].isNode() || this.setDelegate(n["default"]);
              }
              return (
                d(a, [
                  {
                  ...
                  },
                  {
                    ...
                    value: function (a, b) {
                      ...
                      return this._delegate
                        ...
                        .then(function (a) {
                          return (
                            a.status >= 500 && a.status < 600 && c.error5XX(a),
                            a
                          );
                        });
                    },
                  ...
                  },
                  {
                    ...
                    value: function (a, b) {
                      try {
                        if (h["default"].isNullOrUndefined(a)) return null;
                        if (h["default"].isFunction(a.get)) return a.get(b);
                        if (!h["default"].isNullOrUndefined(a[b])) return a[b];
                      } catch (c) {
                        j["default"].warn(
                          "Error reading header: " + b + " " + c + "}"
                        );
                      }
                      return null;
                    },
      ...
      14: [
        function (a, b, c) {
          ...
          var d = a("babel-runtime/helpers/create-class")["default"],
            e = a("babel-runtime/helpers/class-call-check")["default"],
            f = a("babel-runtime/core-js/object/keys")["default"],
            g = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var h = a("./Fetch"),
            i = g(h),
            ...
            l = (function () {
              function a(b) {
                ...
                e(this, a),
                  (this._host = d),
                  (this._path = ""),
                  (this._params = k["default"].extend({}, g)),
                  (this._headers = k["default"].extend({}, i)),
                  (this._body = k["default"].isNullOrUndefined(l) ? void 0 : l),
                  (this._method = k["default"].isNullOrUndefined(l)
                    ? "GET"
                    : "POST");
              }
              return (
                d(a, [
                  ...
                  },
                  {
                    ...
                    value: function () {
                      return k["default"].isString(this._body)
                        ? this._body
                        : k["default"].isNullOrUndefined(this._body)
                        ? this._body
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        (this._headers = k["default"].extend(this._headers, a)),
                        this
                      );
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        (this._params = k["default"].extend(this._params, a)),
                        this
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      var a = this._params;
                      return k["default"].isNullOrUndefined(a)
                        ? ""
                        : f(a)
                            .reduce(function (b, c) {
                              return b + c + "=" + a[c] + "&";
      ...
      15: [
        function (a, b, c) {
          ...
          var d = a("babel-runtime/helpers/create-class")["default"],
            e = a("babel-runtime/helpers/class-call-check")["default"],
            f = a("babel-runtime/helpers/to-consumable-array")["default"],
            g = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var h = a("./Utils"),
            i = g(h),
              ...
              return (
                d(a, [
                  ...
                  },
                  {
                    key: "getDelegate",
                    value: function () {
                      return i["default"].isNullOrUndefined(this._delegate)
                        ? "undefined" != typeof CloudKit &&
                          CloudKit.logToConsole
                          ? console
                          : void 0
                        : this._delegate;
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      if (
                        !i["default"].isNullOrUndefined(a) &&
                        i["default"].isFunction(a.info)
                      ) {
                        for (
      ...
      16: [
        function (a, b, c) {
          ...
          var d = a("babel-runtime/helpers/create-class")["default"],
            e = a("babel-runtime/helpers/class-call-check")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var f = "NOTIFICATION_TYPE_QUERY",
            g = "NOTIFICATION_TYPE_RECORD_ZONE",
            h = "QUERY_NOTIFICATION_REASON_RECORD_CREATED",
            i = "QUERY_NOTIFICATION_REASON_RECORD_UPDATED",
            j = "QUERY_NOTIFICATION_REASON_RECORD_DELETED",
            k = (function () {
              function a(b) {
                e(this, a),
                  (this._notificationID = b.ck.nid),
                  (this._containerIdentifier = b.ck.cid);
                var c = b.aps || {};
                (c.alert = c.alert || {}),
                  (this._category = c.category),
                  (this._alertBody = c.alert.body),
                  (this._alertLocKey = c.alert["loc-key"]),
                  (this._alertLocArgs = c.alert["loc-args"]),
                  (this._actionLocKey = c.alert["action-loc-key"]),
                  (this._launchImage = c.alert["launch-image"]),
                  (this._soundName = c.sound),
                  (this._badge = c.badge);
              }
              return (
                d(
      ...
      17: [
        function (a, b, c) {
          ...
          var f = a("./Utils"),
            ...
            h = a("./Log"),
            i = e(h),
            j = a("./QueryNotification"),
            k = e(j),
            l = a("./RecordZoneNotification"),
            m = e(l);
          (c["default"] = { parseRawNotification: d }),
            (b.exports = c["default"]);
        },
        {
          "./Log": 15,
      ...
      18: [
        function (a, b, c) {
          ...
          var d = "EQUALS",
            e = "NOT_EQUALS",
            f = "LESS_THAN",
            g = "LESS_THAN_OR_EQUALS",
            h = "GREATER_THAN",
            i = "GREATER_THAN_OR_EQUALS",
            j = "NEAR",
            k = "CONTAINS_ALL_TOKENS",
            l = "IN",
            m = "CONTAINS_ANY_TOKENS",
            n = "LIST_CONTAINS",
            o = "NOT_LIST_CONTAINS",
            p = "LIST_CONTAINS_ANY",
            q = "NOT_LIST_CONTAINS_ANY",
            r = "NOT_IN",
            s = "BEGINS_WITH",
            t = "NOT_BEGINS_WITH",
            u = "LIST_MEMBER_BEGINS_WITH",
            v = "NOT_LIST_MEMBER_BEGINS_WITH",
            w = "LIST_CONTAINS_ALL",
            x = "NOT_LIST_CONTAINS_ALL";
          (c["default"] = {
            EQUALS: d,
            NOT_EQUALS: e,
            LESS_THAN: f,
      ...
      19: [
        function (a, b, c) {
          ...
          var d = a("babel-runtime/helpers/get")["default"],
            ...
            f = a("babel-runtime/helpers/create-class")["default"],
            g = a("babel-runtime/helpers/class-call-check")["default"],
            h = a("babel-runtime/core-js/get-iterator")["default"],
            i = a("babel-runtime/core-js/object/get-own-property-names")[
              "default"
            ],
            j = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
            ...
            o = (function (a) {
              function b(a) {
                ...
                if (
                  ...
                  (this._dbType = c.dbs),
                  (this._recordName = c.rid),
                  (this._reason = c.fo),
                  !n["default"].isNullOrUndefined(c.af))
                ) {
                  var e = {},
                    f = !0,
                    j = !1,
                ...
                f(b, [
                  {
                    key: "toString",
                    value: function () {
                      return n["default"].instanceToString(
                        "QueryNotification",
                        this
                      );
                    },
            ...
            m = (function (a) {
              function b(a, c) {
                g(this, b),
                  ...
                  (this._continuationMarker = c.body.continuationMarker);
              }
              return (
                e(b, a),
                f(b, [
                  {
                    key: "toString",
                    value: function () {
                      return l["default"].instanceToString(
                        "QueryResponse",
                        this
                      );
                    },
                  ...
                  },
                  {
                    key: "moreComing",
                    get: function () {
                      return !l["default"].isNullOrUndefined(
      ...
      21: [
        function (a, b, c) {
          ...
          function d(a) {
            if (j["default"].isNullOrUndefined(a))
              throw l["default"].makeInvalidArguments(
                "not a valid record/recordName: " +
                  j["default"].stringifyExposingUndefined(a)
              );
          ...
          function f(a) {
            if (j["default"].isNullOrUndefined(a))
              throw l["default"].makeInvalidArguments(
                "not a valid zone/zoneID: " +
                  j["default"].stringifyExposingUndefined(a)
              );
            if (j["default"].isString(a)) return { zoneID: { zoneName: a } };
            if (j["default"].isString(a.zoneName)) return { zoneID: a };
            if (
              "zoneID" in a &&
              !j["default"].isNullOrUndefined(a.zoneID) &&
              "zoneName" in a.zoneID
            )
              return a;
            throw l["default"].makeInvalidArguments(
              "not a valid zone/zoneID: " +
          ...
          var i = a("./Notification"),
            ...
            m = (function (a) {
              function b(a) {
                ...
                var c = a.ck.fet || {};
                (this._zoneID = { zoneName: c.zid, ownerRecordName: c.zoid }),
                  (this._subscriptionID = c.sid);
              }
              return (
                e(b, a),
                ...
                d(a, [
                  {
                    ...
                    value: function (a, b) {
                      ...
                      return (
                        j["default"]
                          .asArray(b)
                          .map(h["default"].normalizeZone)
                          .map(function (b) {
                            return { zone: b, operationType: a };
                          })
                          .forEach(function (a) {
      ...
      25: [
        function (a, b, c) {
          ...
          function e(a, b) {
            return d(a) ? j["default"].merge(b, { fields: void 0 }) : b;
          }
          var f = a("babel-runtime/helpers/create-class")["default"],
            g = a("babel-runtime/helpers/class-call-check")["default"],
            h = a("babel-runtime/helpers/interop-require-default")["default"];
          ...
          var i = a("./Utils"),
            ...
            A = r["default"].forKeys("desiredKeys", "numbersAsStrings"),
            B = j["default"].makeObjectHasPropsPredicate({
              recordChangeTag: !1,
              recordType: !0,
            }),
                ...
                f(a, [
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      ...
                      return (
                        l["default"].info(
                          "RecordsBatchBuilder#createOrUpdate",
                          a,
                          c
                        ),
                        n["default"].normalizeRecords(a).forEach(function (a) {
                          if (B(a)) b.create(a, c);
                          else {
                            if (!C(a))
                              throw p["default"].makeInvalidArguments(
                    ...
                    value: function (a) {
                      var b =
                        arguments.length <= 1 || void 0 === arguments[1]
                          ...
                          : arguments[1];
                      return (
                        l["default"].info("RecordsBatchBuilder#create", a, b),
                        this._pushOperations(s, a, b)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      var b =
                        arguments.length <= 1 || void 0 === arguments[1]
                          ...
                          : arguments[1];
                      return (
                        l["default"].info("RecordsBatchBuilder#update", a, b),
                        this._pushOperations(t, a, b)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      ...
                      return (
                        l["default"].info(
                          "RecordsBatchBuilder#forceUpdate",
                          a,
                          b
                        ),
                        this._pushOperations(u, a, b)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      var b =
                        arguments.length <= 1 || void 0 === arguments[1]
                          ...
                          : arguments[1];
                      return (
                        l["default"].info("RecordsBatchBuilder#replace", a, b),
                        this._pushOperations(v, a, b)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      ...
                      return (
                        l["default"].info(
                          "RecordsBatchBuilder#forceReplace",
                          a,
                          b
                        ),
                        this._pushOperations(w, a, b)
                      );
                    },
                  },
                  {
                    ...
                    value: function (a) {
                      var b =
                        arguments.length <= 1 || void 0 === arguments[1]
                          ...
                          : arguments[1];
                      return (
                        l["default"].info("RecordsBatchBuilder#delete", a, b),
                        this._pushOperations(x, a, b)
                      );
                    },
                  },
                  {
                    ...
                    value: function () {
                      var a =
                        arguments.length <= 0 || void 0 === arguments[0]
                          ...
                          : arguments[0];
                      return (
                        l["default"].info("RecordsBatchBuilder#commit"),
                        this._database.commitRecordsBatchBuilder(this, a)
                      );
                    },
                  },
                  {
                  ...
                  },
                  {
                    ...
                    value: function (a, b) {
                      this._options.onAssetUploadStart &&
                        this._options.onAssetUploadStart(a, b);
                    },
                  },
                  {
                    key: "zoneID",
        ...
        function (a, b, c) {
          ...
          function d(a, b, c, d) {
            return (
              ...
              b +
              " (in: " +
              j["default"].stringifyExposingUndefined(d) +
              ")"
            );
          }
          function e() {
                ...
                b.forEach(function (b) {
                  if (!b.shouldIgnore || !b.shouldIgnore(a)) {
                    ...
                    if (e in a) {
                      var f = a[e];
                      if (
                        ((f = j["default"].isFunction(b.normalize)
                          ? b.normalize(f)
                          : f),
                        !b.isValid(f))
                      )
          ...
          function f() {
            ...
            var d = b.map(function (a) {
              var b = j["default"].arrayFind(A, function (b) {
                return b.key === a;
              });
              if (!b)
                throw new Error(
                  "Cannot find request option definition for: " + a
                );
              return b;
            });
            return e.apply(void 0, g(d));
          }
          var g = a("babel-runtime/helpers/to-consumable-array")["default"],
            h = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var i = a("./Utils"),
            j = h(i),
            ...
            q = {
              ...
              isValid: function (a) {
                return (
                  j["default"].isUndefined(a) ||
                  (j["default"].isArray(a) && a.every(j["default"].isString))
                );
              },
            ...
            s = {
              ...
              isValid: function (a) {
                return (
                  j["default"].isNullOrUndefined(a) || j["default"].isBoolean(a)
                );
              },
              errorMessage: " should be a boolean but was: ",
            },
            ...
            u = {
              ...
              isValid: function (a) {
                return (
                  j["default"].isNullOrUndefined(a) ||
                  j["default"].isNumberish(a)
                );
              },
            ...
            v = {
              ...
              isValid: function (a) {
                return (
                  j["default"].isNullOrUndefined(a) || j["default"].isString(a)
                );
              },
              ...
              return (
                ...
                f(b, [
                  ...
                  },
                  {
                    ...
                    get: function () {
                      return Boolean(
                        this.request.getPayload().numbersAsStrings
                      );
                    },
                  },
                  {
      ...
      28: [
        function (a, b, c) {
          ...
          var d = "NONE",
            e = "DELETE_SELF",
            f = "VALIDATE";
          (c["default"] = { NONE: d, DELETE_SELF: e, VALIDATE: f }),
            (b.exports = c["default"]);
        },
        {},
      ],
      29: [
        function (a, b, c) {
          ...
          var d = a("babel-runtime/helpers/create-class")["default"],
            e = a("babel-runtime/helpers/class-call-check")["default"],
            f = a("babel-runtime/helpers/get")["default"],
            g = a("babel-runtime/helpers/inherits")["default"],
            h = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var i = a("./Utils"),
            j = h(i),
            ...
            m = a("./Fetch"),
            n = h(m),
            o = "https://feedbackws.icloud.com/reportStats",
            p = 15e3,
            q = "CKJS",
            r = "CKJSNetworkError",
            s = "CKJSStatus5XX",
            t = "CKJSDeprecatedMethod",
            u = "CKJSDeprecatedConfig",
            v = "CKJSDeprecatedOptions",
            w = "CKJSUnexpectedAuthError",
            x = "X-Apple-Request-UUID",
            y = (function () {
              function a(b, c, d) {
                e(this, a),
                  (this._reporting = b),
                  ...
                  (this._message = d);
                try {
                  (this._hostname = window.document.location.hostname),
                    (this._urlPath = window.document.location.pathname);
                } catch (f) {}
              }
              return (
                d(a, [
              ...
              return (
                ...
                d(b, [
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      (this._statName = s),
                        (this._statusCode = a.status),
                        (this._requestUUID = n["default"].readHeader(
                          a.headers,
                          x
                        ));
                    },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      this._stats.length > 0 &&
                        (n["default"].fetch(o, {
                          method: "POST",
                          body: JSON.stringify({ stats: this._stats }),
                          headers: { "content-type": "text/plain" },
                        }),
                        (this._stats = [])),
                        this._flushLater();
      ...
      30: [
        function (a, b, c) {
          ...
          var i = a("./Utils"),
            ...
            m = a("./Fetch"),
            n = h(m),
            o = "x-apple-cloudkit-web-auth-token",
            p = (function () {
              function a(b, c) {
                var d =
                  arguments.length <= 2 || void 0 === arguments[2]
                ...
                if (
                  (e(this, a),
                  j["default"].assertArg(b, "request cannot be null"),
                  j["default"].assertArg(c, "httpResponse cannot be null"),
                  (this._request = b),
                  (this._httpResponse = c),
                  null !== d)
                ) {
                  var f = c.body[d];
                  ...
                  var g = f.reduce(
                      function (a, b) {
                        return (
                          l["default"].isErrorObject(b)
                            ? a.errors.push(l["default"].fromServerError(b))
                            : a.results.push(b),
                          a
                        );
                      },
              ...
              return (
                d(a, [
                  ...
                  },
                  {
                    ...
                    value: function (a) {
                      return (
                        (a = h["default"].asArray(a).map(function (a) {
                          return h["default"].isString(a)
                            ? { subscriptionID: a }
                            : a;
                        })),
                        this._pushOperation(j, a),
                        this
                      );
                    },
                  },
                  {
                    key: "commit",
                    value: function () {
                      return this._database.commitSubscriptionsBatchBuilder(
                        this
                      );
                    },
                  },
      ...
      33: [
        function (a, b, c) {
          ...
          var g = a("./Utils"),
            ...
            i = (function () {
              function a(b) {
                var c = b.userRecordName,
                  d = b.firstName,
                  f = b.lastName,
                  g = b.emailAddress;
                e(this, a),
                  (this.userRecordName = c),
                  (this.emailAddress = g),
                  (this.firstName = d),
                  (this.lastName = f),
                  (this.isDiscoverable =
                    !h["default"].isNullOrUndefined(f) ||
                    !h["default"].isNullOrUndefined(f));
              }
              return (
                d(a, [
                ...
                f(b, [
                  {
                    key: "toString",
                    value: function () {
                      return o["default"].instanceToString(
                        "UserInfosResponse",
                        this
                      );
                    },
        ...
        function (a, b, c) {
          (function (d) {
            ...
            function v() {
              for (var a = arguments.length, b = Array(a), c = 0; a > c; c++)
                b[c] = arguments[c];
              return u.apply(void 0, [{}].concat(b));
            }
            function w(a) {
            ...
            function A(a, b, c) {
              if (z()) {
                ...
                d.location.href = a;
              } else window.open(a, "", "width=" + b + ", height=" + c);
            }
            function B(a, b, c) {
              var d = R["default"].defer(),
                e = function (a) {
            ...
            function C(b) {
              if (t()) return a("url").parse(b);
              var c = S.exec(b),
                d = { host: c[10], pathName: c[13] };
              return d;
            }
            function D(a) {
              var b = Object.getPrototypeOf(a);
              if (b === Object.getPrototypeOf({})) return [];
              var c = D(b);
              return (
            ...
            var K = a("babel-runtime/core-js/number/is-nan")["default"],
              L = a("babel-runtime/core-js/object/keys")["default"],
              M = a("babel-runtime/core-js/get-iterator")["default"],
              N = a("babel-runtime/core-js/object/assign")["default"],
              O = a("babel-runtime/core-js/object/get-own-property-names")[
                "default"
              ],
              P = a("babel-runtime/helpers/interop-require-default")["default"];
            Object.defineProperty(c, "__esModule", { value: !0 });
            var Q = a("./Async"),
              R = P(Q),
              S =
      ...
      36: [
        function (a, b, c) {
          "use strict";
          function d(a, b) {
            return k["default"].canBeCreatedFrom(b)
              ? new k["default"](a, b)
              : i["default"].canBeCreatedFrom(b)
              ? new i["default"](a, b)
              : new g["default"](a, b);
          }
          var e = a("babel-runtime/helpers/interop-require-default")["default"];
          ...
          var f = a("./DefaultAuth"),
            g = e(f),
            h = a("./tokenAndSession/TokenAndSessionAuth"),
            i = e(h),
            j = a("./requestSigning/RequestSigningAuth"),
            k = e(j);
          (c["default"] = { fromContainerDefinition: d }),
            (b.exports = c["default"]);
        },
        {
          "./DefaultAuth": 37,
      ...
      38: [
        function (a, b, c) {
          ...
          function d(a) {
            ...
            return (
              b.update(new n["default"].Buffer(a, "utf-8")), b.digest("base64")
            );
          }
          function e(a, b) {
          ...
          var f = a("babel-runtime/helpers/get")["default"],
            g = a("babel-runtime/helpers/inherits")["default"],
            h = a("babel-runtime/helpers/create-class")["default"],
            i = a("babel-runtime/helpers/class-call-check")["default"],
            j = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var k = a("../DefaultAuth"),
            l = j(k),
            ...
            q = a("../../Async"),
            r = j(q),
            s = n["default"].isNode() ? a("crypto") : null,
            t = n["default"].isNode() ? a("fs") : null,
            u = "serverToServerKeyAuth",
            v = "keyID",
            w = "privateKeyFile",
            x = "privateKeyPassPhrase",
            y = "sha256",
            z = "RSA-SHA256",
            A = (function (a) {
              function b(a, c) {
                  ...
                  [
                    {
                      ...
                      value: function () {
                        if (n["default"].isNullOrUndefined(this._definition[v]))
                          throw p["default"].makeConfigurationError(
                            u +
                              "." +
                              v +
                              " not set in " +
                        ...
                        if (
                          ((this._keyID = this._definition[v]),
                          (this._key = t.readFileSync(
                            this._definition[w],
                            "utf8"
                          )),
                          ...
                          throw p["default"].makeConfigurationError(
                            "Could not read key from " + u + "." + w + "}"
                          );
                        return (
                          n["default"].isNullOrUndefined(this._definition[x]) ||
                            (this._key = {
                              key: this._key,
                      ...
                      value: function () {
                        ...
                        return function (b) {
                          var c = new Date()
                              .toISOString()
                              .replace(/(\.\d\d\d)Z/, "Z"),
                            f = b.getBodyStringified() || "",
                            g = b.getPathWithParams(),
                            h = c + ":" + d(f) + ":" + g,
                            i = null;
                          return (
                            (i = n["default"].isFunction(a._externalSigner)
                              ? a._externalSigner(a._keyID, h)
                              : e(a._key, h)),
                            r["default"].Promise.resolve(i).then(function (d) {
                              return (
                                b.setISODate(c),
                                b.setSigningKeyID(a._keyID),
                                b.setSignatureV1(d),
                                b
                              );
                            })
      ...
      39: [
        function (a, b, c) {
          ...
          var g = a("../../Log"),
            h = f(g),
            i = a("../../Async"),
            j = (f(i), a("./ButtonThemes")),
            k = f(j),
            l = (function () {
              function a(b, c, d) {
                e(this, a),
                  (this.theme = c),
                  (this.wrapper = document.getElementById(b.id)),
                  (this.logLabel = d),
                  (this.button = null);
              }
              return (
                d(
                  ...
                  [
                        ...
                        if (this.canBeAdded())
                          try {
                            (this.button = document.createElement("div")),
                              this.theme.apply(this.button),
                              this.wrapper.appendChild(this.button);
                          } catch (a) {
                            throw (
                              (h["default"].warn(
                                "Could not create button",
                                a,
                                this.wrapper,
                                this.logLabel
                              ),
                          ...
                          h["default"].info(
                            "Cannot find wrapper or wrapper not empty. Not rendering " +
                              this.logLabel
                          );
                        return this;
                      },
                    ...
                    },
                    {
                      ...
                      value: function () {
                        return (
                          this.wrapper && "" === this.wrapper.innerHTML.trim()
                        );
                      },
                    },
                  ],
      ...
      40: [
        function (a, b, c) {
          ...
          var g = a("../../Utils"),
            ...
            p = h["default"].isNode() ? o : m,
            q = (function () {
              function a() {
                e(this, a), this.setDelegate();
              }
              return (
                d(a, [
                  {
                  ...
                  },
                  {
                    ...
                    value: function (a, b) {
                      try {
                        ...
                        throw (
                          (j["default"].warn(c),
                          l["default"].makeAuthPersistError())
                        );
                      }
                    ...
                    value: function (a) {
                      (this.elt = a),
                        (a.style["background-image"] =
                          'url("' + this.asset + '")'),
                        (a.style["background-size"] = "218px 40px"),
                        (a.style.width = "218px"),
                        (a.style.height = "40px"),
      ...
      42: [
        function (a, b, c) {
          ...
          function d(a) {
            if (k["default"].isNullOrUndefined(a[A])) {
              if (k["default"].isNullOrUndefined(a[z])) {
                ...
                var b =
                  "containerConfig.apiToken and containerConfig.auth are deprecated. Use containerConfig." +
                  A +
                  " instead.";
                o["default"].warn(b),
                  y["default"].reportDeprecatedConfigurationUsed(b);
                var c = a.auth || {};
                return {
                  apiToken: a[B],
                  persist: !!c.persist,
              ...
              var b =
                "containerConfig." +
                z +
                " is deprecated. Use containerConfig." +
                A +
                " instead.";
              o["default"].warn(b),
                y["default"].reportDeprecatedConfigurationUsed(b);
          ...
          var e = a("babel-runtime/helpers/get")["default"],
            f = a("babel-runtime/helpers/inherits")["default"],
            g = a("babel-runtime/helpers/create-class")["default"],
            h = a("babel-runtime/helpers/class-call-check")["default"],
            i = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 });
          var j = a("../../Utils"),
            k = i(j),
            ...
            G = (function (a) {
              function b(a, c) {
                ...
                var f = d(c);
                f.persist && (this._authTokenStore = u["default"]),
                  (this._apiToken = f.apiToken),
                  (this._signInButtonDefinition = k["default"].extend(
                    {},
                    F.signInButton,
                    f.signInButton
                  )),
                  (this._signOutButtonDefinition = k["default"].extend(
                    {},
                    F.signOutButton,
                    f.signOutButton
                  )),
                  (this._ckSession = null),
                  (this._signInURL = null),
                  ...
                  [
                    {
                      ...
                      value: function () {
                        return (
                          this.signInButton && this.signInButton.remove(),
                          this.signOutButton && this.signOutButton.remove(),
                          (this.signInButton = s["default"].makeSignInButton(
                            this._signInButtonDefinition
                          )),
                          (this.signOutButton = s["default"].makeSignOutButton(
                            this._signOutButtonDefinition
                          )),
                          this._fetchAndHandleUserInfo()
                        );
                      },
                    },
                    {
                      ...
                      value: function () {
                        ...
                        return function (b) {
                          return a._getSessionAsync().then(function (c) {
                            return (
                              b.setCKSession(c), b.setApiToken(a._apiToken), b
                            );
                          });
                        };
                      },
                    },
                    {
                      ...
                      value: function () {
                        ...
                        return function (b) {
                          return (
                            k["default"].isNullOrUndefined(b.getCKSession()) ||
                              a._setSession(b.getCKSession()),
                            b
                          );
                        };
                      },
                    },
                    {
                      ...
                      value: function () {
                        var a = this,
                          b = m["default"].Promise.resolve(this._ckSession);
                        return (
                          this._authTokenStore &&
                            (b = m["default"].Promise.resolve(
                              this._authTokenStore.getToken(
                                this._container.containerIdentifier
                              )
                            ).then(function (b) {
                      ...
                      value: function () {
                        ...
                        return this._fetchUserInfo()
                          ...
                          ["catch"](function (b) {
                            if (
                              b.ckErrorCode ===
                              q["default"].AUTHENTICATION_REQUIRED
                            )
                    ...
                    },
                    {
                      ...
                      value: function (a) {
                        ...
                        (this._signInURL = a),
                          setTimeout(function () {
                            return b
                              ._fetchAndHandleUserInfo()
                              ["catch"](function () {});
                          }, E),
                          this.signInButton.add().clickHandler(function () {
                            k["default"]
                              .getAsyncMessageFromPopup(b._signInURL, D, C)
                              .then(function (a) {
                                var c = a.data.ckSession;
                                if (k["default"].isNullOrUndefined(c))
                                  throw k["default"].isNullOrUndefined(
                                    a.data.errorMessage
                                  )
                                    ? (o["default"].warn(
                                      ...
                                      q["default"].makeUnknownError())
                                    : (o["default"].warn(
                                        "Message event from popup reports error: ",
                                        a.data
                                      ),
                                      q["default"].makeSignInFailedError(
                                        a.data
                                      ));
                                b._setSession(c);
                              })
                              ...
                              ["catch"](function (a) {
                                y["default"].reportUnexpectedAuthError(),
                                  o["default"].warn("Unexpected error", a),
                                  b._whenUserSignsIn.reject(a),
                                  (b._whenUserSignsIn = m["default"].defer()),
                                  b.setup();
                              });
                          });
                      },
                    },
                    {
                      ...
                      value: function (a) {
                        ...
                        return (
                          ...
                          this._whenUserSignsIn.resolve(a),
                          (this._whenUserSignsIn = m["default"].defer()),
                          this.signOutButton.add().clickHandler(function () {
                            b._setSession(null),
                              b._whenUserSignsOut.resolve(),
                              (b._whenUserSignsOut = m["default"].defer()),
                              b.setup();
                          }),
                          a
                        );
                  ...
                  [
                    {
                      ...
                      value: function (a) {
                        return (
                          !k["default"].isNullOrUndefined(a[B]) ||
                          !k["default"].isNullOrUndefined(a[z]) ||
                          !k["default"].isNullOrUndefined(a[A])
                        );
                      },
                    },
                  ]
      ...
      45: [
        function (a, b, c) {
          ...
          var e = a("babel-runtime/helpers/create-class")["default"],
            f = a("babel-runtime/helpers/class-call-check")["default"],
            g = a("babel-runtime/helpers/get")["default"],
            h = a("babel-runtime/helpers/inherits")["default"],
            i = a("babel-runtime/core-js/map")["default"],
            j = a("babel-runtime/core-js/object/get-own-property-names")[
              "default"
            ],
            k = a("babel-runtime/core-js/set")["default"],
            l = a("babel-runtime/core-js/get-iterator")["default"],
            m = a("babel-runtime/helpers/interop-require-default")["default"];
          Object.defineProperty(c, "__esModule", { value: !0 }),
            (c["default"] = d);
          var n = a("./../Async"),
            o = m(n),
                  ...
                  [
                    {
                      ...
                      value: function (a, b) {
                        (a = a.toLowerCase()),
                          this.has(a) ? this.getAll(a).add(b) : this.set(a, b);
                      },
                    },
                    {
                      key: "delete",
                    ...
                    },
                    {
                      ...
                      value: function (a) {
                        return (
                          (a = a.toLowerCase()),
                          this.has(a) ? this._headers.get(a) : new k()
                        );
                      },
                    },
                    {
                    ...
                    },
                    {
                      ...
                      value: function (a, b) {
                        (a = a.toLowerCase()),
                          this._headers.set(a, new k().add(b));
                      },
                    },
                    {
                      key: "forEach",
                  ...
                  [
                    {
                      ...
                      value: function (b) {
                        var c = new a(),
                          d = b.getAllResponseHeaders().trim().split("\n");
                        return (
                ...
                e(a, [
                  {
                    ...
                    value: function () {
                      return this.bodyUsed
                        ? o["default"].Promise.reject(
                            new TypeError("Body already used")
                          )
                        : ((this.bodyUsed = !0),
                          o["default"].Promise.resolve(this._payload));
                    },
                  },
                  {
                    key: "json",
                  ...
                  },
                  {
                    key: "blob",
                    value: function () {
                      return o["default"].Promise.resolve(
                        new Blob([this._payload])
                      );
                    },
                  },
                ]),
            ...
            s = (function (a) {
              function b(a) {
                ...
                f(this, b),
                  ...
                  (this.url = a),
                  (this.credentials = c.credentials || "omit"),
                  (this.headers = new p(c.headers)),
                  (this.method = c.method ? c.method.toUpperCase() : "GET"),
                  (this.mode = c.mode || null),
                  (this.options = c);
              }
              return (
                h(b, a),
                    ...
                    value: function () {
                      ...
                      return new o["default"].Promise(function (b, c) {
                        ...
                        function e() {
                          f.removeEventListener("load", d),
                            f.removeEventListener("error", e),
                            c(new TypeError("Network failure"));
                        }
                        var f = new XMLHttpRequest();
                        "include" === a.credentials && (f.withCredentials = !0),
                          f.addEventListener("load", d),
                          f.addEventListener("error", e),
                          a.options &&
                            a.options.exposeImplementation &&
                            a.options.exposeImplementation(f),
                          ...
                          f.send(
                            "undefined" == typeof a._payload ? null : a._payload
                          );
                      });
                    },
                  },
      ...
      50: [
        function (a, b, c) {
          b.exports = { default: a("core-js/library/fn/map"), __esModule: !0 };
        },
      ...
      62: [
        function (a, b, c) {
          b.exports = { default: a("core-js/library/fn/set"), __esModule: !0 };
        },
      ...
      65: [
        function (a, b, c) {
          "use strict";
          var d = a("babel-runtime/core-js/object/get-own-property-descriptor")[
            "default"
          ];
      ...
      69: [
        function (a, b, c) {
          a("../../modules/es6.string.iterator"),
            ...
            (b.exports = a("../../modules/$.core").Array.from);
        },
        {
          "../../modules/$.core": 92,
      ...
      72: [
        function (a, b, c) {
          a("../../modules/es6.number.is-nan"),
            (b.exports = a("../../modules/$.core").Number.isNaN);
        },
        { "../../modules/$.core": 92, "../../modules/es6.number.is-nan": 144 },
      ],
      73: [
        function (a, b, c) {
        ...
        { "../../modules/$.core": 92, "../../modules/es6.object.assign": 145 },
      ],
      74: [
        function (a, b, c) {
          var d = a("../../modules/$");
      ...
      79: [
        function (a, b, c) {
          a("../../modules/es6.object.keys"),
            (b.exports = a("../../modules/$.core").Object.keys);
        },
        { "../../modules/$.core": 92, "../../modules/es6.object.keys": 148 },
      ],
      80: [
        function (a, b, c) {
          a("../../modules/es6.object.set-prototype-of"),
            (b.exports = a("../../modules/$.core").Object.setPrototypeOf);
        },
        {
          "../../modules/$.core": 92,
      ...
      81: [
        function (a, b, c) {
          a("../../modules/es7.object.values"),
            (b.exports = a("../../modules/$.core").Object.values);
        },
        { "../../modules/$.core": 92, "../../modules/es7.object.values": 155 },
      ],
      82: [
        function (a, b, c) {
          a("../modules/es6.object.to-string"),
            ...
            (b.exports = a("../modules/$.core").Promise);
        },
        {
          "../modules/$.core": 92,
          "../modules/es6.object.to-string": 150,
          ...
          b.exports = a("./$.fails")(function () {
            ...
            ? function (a, b) {
                for (var c = d(a), g = arguments.length, h = 1; g > h; )
                  for (
                    var i, j = e(arguments[h++]), k = f(j), l = k.length, m = 0;
                    l > m;
            ...
            return (
              ...
              (l ||
                ...
                ? ((n = c(function (a, c) {
                  ...
                  "size" in p &&
                    d.setDesc(n.prototype, "size", {
                      get: function () {
                        return this._c.size;
                      },
                    }))
                : ((n = j.getConstructor(c, b, k, o)),
                  a("./$.mix")(n.prototype, i)),
              a("./$.tag")(n, b),
              (q[b] = n),
              e(e.G + e.W + e.F, q),
      ...
      101: [
        function (a, b, c) {
          var d = "undefined",
            e = (b.exports =
              typeof window != d && window.Math == Math
                ? window
                : typeof self != d && self.Math == Math
                ? self
      ...
      103: [
        ...
        { "./$": 115, "./$.property-desc": 121, "./$.support-desc": 129 },
      ],
      104: [
        function (a, b, c) {
          ...
          b.exports = function (b, c, p, q, r, s, t) {
            ...
            if (((!d || t) && g(y, i, A), (j[c] = A), (j[x] = o), r))
              if (
                ...
                for (v in u) v in y || f(y, v, u[v]);
              else e(e.P + e.F * k, c, u);
          };
        },
        {
          "./$": 115,
      ...
      117: [
        function (a, b, c) {
          ...
          if (k)
            ...
            new i(l).observe(n, { characterData: !0 }),
              (f = function () {
                n.data = m = -m;
              });
          } else
          ...
          b.exports = function (a) {
            var b = { fn: a, next: void 0, domain: k && j.domain };
            e && (e.next = b), d || ((d = b), f()), (e = b);
          };
        },
        { "./$.cof": 88, "./$.global": 101, "./$.task": 131 },
      ],
      118: [
        function (a, b, c) {
          var d = a("./$.redef");
          ...
          b.exports = function (a) {
            return function (b) {
              var c,
                ...
                i = 0,
                j = Array(h);
              if (a) for (; h > i; ) j[i] = [(c = g[i++]), f[c]];
              else for (; h > i; ) j[i] = f[g[i++]];
              return j;
            };
          };
        },
      ...
      138: [
        function (a, b, c) {
          ...
          b.exports = function (b) {
            return (
              d[b] || (d[b] = (e && e[b]) || (e || a("./$.uid"))("Symbol." + b))
            );
          };
        },
        { "./$.global": 101, "./$.shared": 125, "./$.uid": 136 },
      ],
      139: [
        function (a, b, c) {
          var d = a("./$.classof"),
            ...
            "Array",
            {
              from: function (a) {
                var b,
                  ...
                  q = j(l);
                if (
                  (o && (n = d(n, arguments[2], 2)),
                  void 0 == q || (m == Array && h(q)))
                )
      ...
      143: [
        ...
        { "./$.collection": 91, "./$.collection-strong": 89 },
      ],
      144: [
        function (a, b, c) {
          var d = a("./$.def");
      ...
      145: [
        function (a, b, c) {
          var d = a("./$.def");
          d(d.S + d.F, "Object", { assign: a("./$.assign") });
        },
        { "./$.assign": 86, "./$.def": 94 },
      ],
      146: [
        ...
        function (a, b, c) {
          ...
          var d,
            ...
            A = (function () {
              ...
              try {
                if (
                  ((c = y && y.resolve && z()),
                  p(b, y),
                  (b.prototype = e.create(y.prototype, {
                    constructor: { value: b },
                  })),
                        ...
                        try {
                          g
                            ? (e || (a.h = !0),
                              (c = g === !0 ? d : g(d)),
                              c === b.P
                                ? b.rej(TypeError("Promise-chain cycle"))
                                : (f = E(c))
                                ? f.call(c, b.res, b.rej)
                                : b.res(c))
                            : b.rej(d);
                        } catch (h) {
                          b.rej(h);
                  ...
                  (c.length = 0),
                    ...
                    b &&
                      setTimeout(function () {
                        G(a.p) &&
                          (x
                            ? w.emit("unhandledRejection", d, a.p)
                            : g.console &&
                              console.error &&
                              console.error("Unhandled promise rejection", d)),
                          (a.a = void 0);
                      }, 1);
                });
              }
            ...
            G = function (a) {
              ...
              if (c.h) return !1;
              for (; d.length > e; )
                if (((b = d[e++]), b.fail || !G(b.P))) return !1;
              return !0;
            },
            H = function (a) {
              var b = this;
          ...
          A ||
            ...
            j(j.S + j.F * (!A || z(!0)), v, {
              resolve: function (a) {
                return B(a) && C(a.constructor, this)
                  ? a
                  : new this(function (b) {
                      b(a);
                    });
      ...
      157: [
        ...
        { "./$.iterators": 114, "./es6.array.iterator": 142 },
      ],
    },
    {},
    [8]
